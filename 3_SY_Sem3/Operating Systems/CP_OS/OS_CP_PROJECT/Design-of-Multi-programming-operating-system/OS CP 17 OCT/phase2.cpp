...
int main() {
    fin.open("input.txt");
    string path = "/run/media/tanishqthuse/HDD-500GB/Backup/Tanishq/VIT/VIT_File/SY_VIT/3_SY_Sem3/Operating Systems/CP_OS/OS_CP_PROJECT/Design-of-Multi-programming-operating-system/OS CP 17 OCT/new/output.txt";
